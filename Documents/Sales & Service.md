...
Copilot for Sales and Service have evolved significantly through 2025 and into 2026, with the agent model now front-and-centre.

**For sales professionals:**
- **Sales Agent** — an autonomous agent that researches and prioritises leads, drafts outreach, and proposes next-best actions based on CRM signals. Available across Dynamics 365 and Salesforce-connected tenants.
- **Sales Chat** — a chat surface that pulls together the CRM record, recent emails, meetings, and Teams conversations for a given account, replacing the need to manually pivot across systems.
- **Save meeting notes to CRM** directly from Teams, with structured action items.
- **Mobile parity** — Copilot for Sales features in the Outlook mobile app reach near-parity with desktop.
- **Tighter email coaching** that incorporates upcoming meeting context into draft suggestions.

**For service agents:**
- **Specialised intelligent agents** for Customer Intent, Knowledge Management, Case Management, Scheduling, and Sales Order processing. Each replaces a slice of repetitive case work.
- **Inline email summary and drafting** in the service console — no need to leave the case to handle correspondence.
- **Broader CRM connectivity** including richer ServiceNow, Salesforce, and Zendesk integration.
- **Embedded case summary views** customisable per workspace.

For tenants on the Frontier early-access program (see the [Frontier &amp; CoWork](#frontier) guide), Researcher and Analyst can be invoked from Sales Chat to produce deep account briefs and pipeline analyses respectively.

Stay informed via the **Microsoft 365 Roadmap** (filter by Dynamics 365 / Copilot for Sales / Copilot for Service) and your organisation's CRM administrator.